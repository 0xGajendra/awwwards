...
const BentoCard = ({src, title, description}) => {
    return (
        <div className='relative size-full'>
            ...
            />
            <div className='relative z-10 flex size-full justify-between p-5 text-blue-50'>
                <div>
      ...
      <section className='bg-black pb-52'>
        <div className='container mx-auto px-3 md:px-10'>
            ...
            <p className='max-w-md font-circular-web text-lg text-blue-50 opacity-50'> 
                Immerce yourslef in a rich and ever-expanding universe where a vibrant array of products converge into an interconnected overloay experience on your world
            </p>
            </div>
